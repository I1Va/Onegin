...
line_data *place_pointers(char *const data_start, const size_t n_lines, const size_t file_sz, size_t *max_line_sz, err_code *const return_err);

size_t input_data(const char *path, char **data_start, const size_t file_sz, err_code *const return_err);
